...
export default function Contact() {
      ...
      >
        ...
        <div className="icons-container">
          <div className="card">
            ...
            <a href="https://www.instagram.com/smuggler-teritory" className="socialContainer containerFour">
  <svg className="socialSvg instagramSvg" viewBox="0 0 16 16" fill="currentColor">
    ...
    <div class="title-circuit">
      <ul class="title-wrapper">
          <li className="title-text">M</li>
          <li className="title-text">E</li>
          <li className="title-text">R</li>
          <li className="title-text">N</li>
          <li className="title-text">&nbsp;</li>
          <li className="title-text">S</li>
          <li className="title-text">T</li>
          <li className="title-text">A</li>
          <li className="title-text">C</li>
          <li className="title-text">K</li>
          <li className="title-text">&nbsp;</li>
          <li className="title-text">D</li>
          <li className="title-text">E</li>
          <li className="title-text">V</li>
          <li className="title-text">E</li>
          <li className="title-text">L</li>
          <li className="title-text">O</li>
          <li className="title-text">P</li>
          <li className="title-text">E</li>
          <li className="title-text">R</li>
        </ul>
    </div>
